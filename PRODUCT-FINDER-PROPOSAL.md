...
7. **Attribute mapping UI + completeness view.** Build the admin screen that lets a real merchant map their own attributes, backed by the already-tested completeness calculation from step 2.
